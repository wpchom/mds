...
#ifndef CONFIG_MDS_CONFIG_FILE
#define CONFIG_MDS_CONFIG_FILE "mds_config.h"
#endif

#if __has_include(CONFIG_MDS_CONFIG_FILE)
...
/* Typedef ----------------------------------------------------------------- */
#if (defined(CONFIG_MDS_TICK_U64) && (CONFIG_MDS_TICK_U64 > 0))
