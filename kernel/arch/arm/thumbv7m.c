...
size_t MDS_CoreSchedulerFFS(register size_t value)
{
...
__attribute__((noreturn)) void MDS_CoreHardFaultException(struct ExceptionInfo *excInfo)
{
    ...
    if (g_exceptionContext == NULL) {
        ...
        MDS_LOG_P("[HARDFAULT] on ipsr:%" PRIxPTR " exc_return:%" PRIx32,
                  MDS_CoreInterruptCurrent(), excInfo->exc_return);
        MDS_LOG_P("r0:%p r1:%p r2:%p r3:%p", (void *)(g_exceptionContext->exception.r0),
                  (void *)(g_exceptionContext->exception.r1),
                  (void *)(g_exceptionContext->exception.r2),
                  (void *)(g_exceptionContext->exception.r3));
        MDS_LOG_P("r4:%p r5:%p r6:%p r7:%p", (void *)(g_exceptionContext->r4),
                  (void *)(g_exceptionContext->r5), (void *)(g_exceptionContext->r6),
                  (void *)(g_exceptionContext->r7));
        MDS_LOG_P("r8:%p r9:%p r10:%p r11:%p", (void *)(g_exceptionContext->r8),
                  (void *)(g_exceptionContext->r9), (void *)(g_exceptionContext->r10),
                  (void *)(g_exceptionContext->r11));
        MDS_LOG_P("r12:%p lr:%p pc:%p psr:%p", (void *)(g_exceptionContext->exception.r12),
