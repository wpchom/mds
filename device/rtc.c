...
{
    return ((DEV_RTC_Timer_t *)MDS_DevPeriphCreate(sizeof(DEV_RTC_Timer_t), name,
                                                   (MDS_DevAdaptr_t *)rtc));
}
...
MDS_Err_t DEV_RTC_TimerStop(DEV_RTC_Timer_t *timer)
{
    ...
    return (timer->mount->driver->timer(timer, MDS_TIMEOUT_NOWAIT));
}
...
{
    return ((DEV_RTC_Alarm_t *)MDS_DevPeriphCreate(sizeof(DEV_RTC_Alarm_t), name,
                                                   (MDS_DevAdaptr_t *)rtc));
}
