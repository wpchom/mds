...
typedef struct MDS_BOOT_UpgradeOps {
    size_t (*read)(MDS_BOOT_Device_t *dev, uintptr_t ofs, uint8_t *data, size_t len);
    size_t (*write)(MDS_BOOT_Device_t *dev, uintptr_t ofs, const uint8_t *data, size_t len);
    size_t (*erase)(MDS_BOOT_Device_t *dev);
} MDS_BOOT_UpgradeOps_t;

/* Function ---------------------------------------------------------------- */
size_t MDS_BOOT_DeviceRead(MDS_BOOT_Device_t *dev, uintptr_t ofs, uint8_t *buff, size_t size);
size_t MDS_BOOT_DeviceWrite(MDS_BOOT_Device_t *dev, uintptr_t ofs, const uint8_t *buff,
                            size_t size);
