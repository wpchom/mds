 ...
 **/
/* Include ----------------------------------------------------------------- */
#include "mds/device/adc.h"

/* ADC adaptr -------------------------------------------------------------- */
MDS_Err_t DEV_ADC_AdaptrInit(DEV_ADC_Adaptr_t *adc, const char *name,
                             const DEV_ADC_Driver_t *driver, MDS_DevHandle_t handle, MDS_Arg_t init)
{
...
{
    DEV_ADC_Periph_t *periph = (DEV_ADC_Periph_t *)MDS_DevPeriphCreate(
        sizeof(DEV_ADC_Periph_t), name, (MDS_DevAdaptr_t *)adc);
